...
angular.module('gigPlanner').controller('BandDetailController', ["Band", "Event", "$scope", "$stateParams", "$timeout", "Modal", function(Band, Event, $scope, $stateParams, $timeout, Modal){
